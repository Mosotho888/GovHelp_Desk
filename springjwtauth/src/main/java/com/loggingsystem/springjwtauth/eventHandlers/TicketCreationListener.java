...
public class TicketCreationListener {
    ...
    public TicketCreationListener(EmailNotificationRepository emailNotificationRepository, TicketsServices ticketsService, EmployeesServices employeesService, JavaMailSender mailSender) {
