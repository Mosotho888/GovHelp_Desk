...
public class TicketStatusChangeListener {
    ...
    public TicketStatusChangeListener(EmailNotificationRepository emailNotificationRepository, TicketsServices ticketsService, EmployeesServices employeesService, JavaMailSender mailSender) {
