...
[`docs/security/README.md`](../security/security-model.md#file-upload-safety) for the full validation and storage-safety
model.
...
see [`docs/security/README.md`](../security/security-model.md#rate-limiting).
