...
INSERT INTO users (id, name, email, password_hash, role, phone, timezone, active, login_attempts, created_at, updated_at)
VALUES
    (1, 'System Administrator', 'admin@helpdesk.gov.za',
...
INSERT INTO tickets (id, subject, description, status, priority, category, requester_id, assignee_id, escalated, created_at, updated_at)
VALUES
    (5, 'Laptop wont start', 'Black screen after update. Tried hard reset, no luck.',
...
VALUES
    (7, 6, 3, NULL, 'Checking permissions with the Cloud Admin.', true, 'NOTE', now()),
...
VALUES
    (1, 5, 4, 'error_log.txt', 'text/plain', 1024, '/storage/tickets/1/error_log.txt', now()),
...
VALUES
    (1, 5, 1, 'STATUS_CHANGE', 'OPEN', 'IN_PROGRESS', now()),
