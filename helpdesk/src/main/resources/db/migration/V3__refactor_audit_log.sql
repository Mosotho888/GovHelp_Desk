...
SET actor_name = u.name,
    actor_role = u.role FROM users u
...
ALTER
COLUMN actor_name  SET NOT NULL,
    ALTER
COLUMN actor_role  SET NOT NULL;

-- 8. Widen value columns and drop NOT NULL on new_value
ALTER TABLE audit_log
ALTER
COLUMN old_value TYPE VARCHAR(255),
    ALTER
COLUMN new_value TYPE VARCHAR(255),
    ALTER
COLUMN new_value DROP
NOT NULL;
