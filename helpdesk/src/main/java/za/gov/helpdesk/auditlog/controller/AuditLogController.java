...
@Tag(name = "Audit Log", description = "System-wide immutable audit trail - Admin and Agent access only")
...
public class AuditLogController {
    ...
    public ResponseEntity<List<AuditLogResponse>> getTicketAuditLogs(@PathVariable Long id) {
    ...
    public ResponseEntity<List<AuditLogResponse>> getAgentAuditLogs(@PathVariable Long id) {
