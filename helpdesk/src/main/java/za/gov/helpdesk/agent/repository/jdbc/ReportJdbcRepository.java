...
public class ReportJdbcRepository {
    ...
    public Map<String, Object> getAgentsStats(Long agentId) {
        ...
        Map<String, Object> stats = jdbc.queryForMap(sql, new MapSqlParameterSource("agentId", agentId));
        ...
        try {
            Map<String, Object> avgResult = jdbc.queryForMap(avgSql, new MapSqlParameterSource("agentId", agentId));
