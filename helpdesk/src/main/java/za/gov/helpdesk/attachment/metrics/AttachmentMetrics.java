...
public class AttachmentMetrics {
    ...
    public AttachmentMetrics(final MeterRegistry registry) {

        this.uploaded =
                Counter.builder("helpdesk.attachment.uploaded")
                        .description("Total files uploaded to tickets")
                        .register(registry);

        this.downloaded =
                Counter.builder("helpdesk.attachment.downloaded")
                        .description("Total attachment download events")
                        .register(registry);

        this.deleted =
                Counter.builder("helpdesk.attachment.deleted")
                        .description("Total attachments deleted from tickets")
                        .register(registry);

        this.uploadBytes =
                DistributionSummary.builder("helpdesk.attachment.upload.bytes")
    ...
    public void recordUploadedSize(final long sizeBytes) {
