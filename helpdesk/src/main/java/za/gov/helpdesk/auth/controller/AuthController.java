...
public class AuthController {
    ...
    @Operation(summary = "Request a password reset OTP", description = "Sends a 6-digit OTP to the email if it exists. Always returns 200 to prevent "
            + "user enumeration.")
    public ResponseEntity<Map<String, String>> requestPasswordReset(@Valid @RequestBody PasswordResetRequest request) {
        ...
        return ResponseEntity
                .ok(Map.of("message", "If that email is registered you will receive a reset code shortly"));
    }

    @PostMapping("/password-reset/confirm")
    @Operation(summary = "Confirm OTP and set new password", description = "Validates the OTP and updates the password. All active sessions are revoked.")
    public ResponseEntity<Map<String, String>> confirmPasswordReset(
        ...
        return ResponseEntity
                .ok(Map.of("message", "Password updated successfully. Please log in with your new password."));
    }
}
