...
public interface TicketRepository extends JpaRepository<Ticket, Long> {
    ...
    @Query("""
           ...
           """)
    Page<Ticket> findWithFilters(@Param("status") Ticket.Status status, @Param("priority") Ticket.Priority priority,
    ...
    @Query("""
           ...
           """)
    Optional<Ticket> findByIdAndPrincipal(@Param("ticketId") Long ticketId, @Param("email") String email,
    ...
    @Modifying
    @Query("UPDATE Ticket t SET t.assignee = null " + "WHERE t.assignee = :agent "
