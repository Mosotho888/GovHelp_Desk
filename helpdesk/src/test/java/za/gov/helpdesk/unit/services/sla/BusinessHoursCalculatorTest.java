...
class BusinessHoursCalculatorTest {
    ...
    void addBusinessMinutes_sameBusinessDay() {
        final LocalDateTime start = LocalDateTime.of(2026, 5, 27, 9, 15);

        final LocalDateTime result = calculator.addBusinessMinutes(start, 90);
    ...
    void addBusinessMinutes_beforeHours_snapsToBusinessStart() {
        final LocalDateTime start = LocalDateTime.of(2026, 5, 27, 6, 30);
    ...
    void addBusinessMinutes_afterHours_snapsToNextBusinessDay() {
        final LocalDateTime start = LocalDateTime.of(2026, 5, 27, 17, 0);

        final LocalDateTime result = calculator.addBusinessMinutes(start, 45);
    ...
    void addBusinessMinutes_crossesBusinessDayBoundary() {
        final LocalDateTime start = LocalDateTime.of(2026, 5, 27, 16, 30);
    ...
    void addBusinessMinutes_weekendStart_skipsToMonday() {
        final LocalDateTime start = LocalDateTime.of(2026, 5, 30, 10, 0);
    ...
    void addBusinessMinutes_fridayCrossing_skipsWeekend() {
        final LocalDateTime start = LocalDateTime.of(2026, 5, 29, 16, 30);
