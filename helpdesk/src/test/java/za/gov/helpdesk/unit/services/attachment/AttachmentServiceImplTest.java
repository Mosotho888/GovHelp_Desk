...
public class AttachmentServiceImplTest {
    ...
    void setUp() {
        ...
        attachment =
                Attachment.builder()
                        ...
                        .sizeBytes(1024L)
                        .storagePath("/tmp/helpdesk-test/10/report.pdf")
                        .build();
    }
    ...
    void upload_validFile_savesAndPublishesAudit() {
        final MockMultipartFile file = pdfFile("report.pdf");
    ...
    void upload_delegatesBatchValidationToValidator() {
        final List<MultipartFile> files = List.of(pdfFile("a.pdf"));
        ...
        then(ticketQuery).shouldHaveNoInteractions();
    }
    ...
    void upload_delegatesFileValidationToValidator() {
        ...
        assertThatThrownBy(
                        () -> attachmentService.uploadAttachments(10L, List.of(exeFile), uploader))
                .isInstanceOf(IllegalArgumentException.class)
    ...
    void deleteAttachment_byAdmin_deletesSuccessfully() {
        final Attachment otherUsersAttachment =
                Attachment.builder()
                        .id(51L)
                        .ticket(ticket)
                        .uploader(uploader)
                        ...
                        .contentType("application/pdf")
                        .sizeBytes(512L)
                        .storagePath("/tmp/helpdesk-test/10/other.pdf")
                        .build();

        given(attachmentQuery.findOrThrow(51L, adminUser)).willReturn(otherUsersAttachment);
    ...
    @Test
    @DisplayName(
            "deleteAttachment() throws AccessDeniedException when non-owner non-admin tries to"
                    + " delete")
    void deleteAttachment_nonOwnerNonAdmin_throwsAccessDenied() {
        ...
        given(attachmentQuery.findOrThrow(50L, otherUser)).willReturn(attachment);
    ...
    private AttachmentResponse mockAttachmentResponse() {
        final UserResponse mockUploader =
